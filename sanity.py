...
curs.execute('select Distinct e.AlertID, a.MOID,b.MO,b.class AS CLASS_ID,d.NAME as CLASS_NAME,c.FIRST1,c.CLEARED,c.TEXT1,b.NAME,e.STRVALUE from MOATT a , MO b ,ALERTLOG c ,class d,Alertprop e where  a.MOID=b.MO and b.MO=c.MO and b.class=d.class and c.Alert=e.AlertID and c.CLEARED IS null  and e.STRVALUE=:pn',name_p)
